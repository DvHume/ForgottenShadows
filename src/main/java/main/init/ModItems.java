...
public class ModItems {
    ...
    // ============================================================
    public static final RegistryObject<Item> DIVINE_METAL = ITEMS.register("divine_metal",
            () -> new Item(new Item.Properties().tab(ModItemGroups.MATERIALS)));

    public static final RegistryObject<Item> TIN = ITEMS.register("tin_ingot",
            () -> new Item(new Item.Properties().tab(ModItemGroups.MATERIALS)));

    public static final RegistryObject<Item> FLAMING_INGOT = ITEMS.register("flaming_ingot",
            () -> new Item(new Item.Properties().tab(ModItemGroups.MATERIALS)));

    public static final RegistryObject<Item> DARK_STEEL_INGOT = ITEMS.register("dark_steel_ingot",
            () -> new Item(new Item.Properties().tab(ModItemGroups.MATERIALS)));

    public static final RegistryObject<Item> VIRTON_SHARD = ITEMS.register("virton_shard",
            () -> new Item(new Item.Properties().tab(ModItemGroups.MATERIALS)));

    public static final RegistryObject<Item> VIRTON_CRYSTAL = ITEMS.register("virton_crystal",
            () -> new Item(new Item.Properties().tab(ModItemGroups.MATERIALS)));
    ...
    public static final RegistryObject<Item> FERROX_POWDER = ITEMS.register("ferrox_powder",
            () -> new Item(new Item.Properties().tab(ModItemGroups.MATERIALS)));

    public static final RegistryObject<Item> FERROX_INGOT = ITEMS.register("ferrox_ingot",
            () -> new Item(new Item.Properties().tab(ModItemGroups.MATERIALS)));
    ...
    public static final RegistryObject<Item> SOLUTION_TANK = ITEMS.register("solution_tank",
            () -> new Item(new Item.Properties().tab(ModItemGroups.MATERIALS)));
    ...
    public static final RegistryObject<Item> RADIUM = ITEMS.register("radium",
            () -> new RadioactiveItem(new Item.Properties().tab(ModItemGroups.MATERIALS), 0.03F));

    public static final RegistryObject<Item> POLONIUM = ITEMS.register("polonium",
            () -> new RadioactiveItem(new Item.Properties().tab(ModItemGroups.MATERIALS), 0.02F));

    public static final RegistryObject<Item> URANIUM = ITEMS.register("uranium",
            () -> new RadioactiveItem(new Item.Properties().tab(ModItemGroups.MATERIALS), 0.005F));

    public static final RegistryObject<Item> RADIOACTIVE_DUST = ITEMS.register("radioactive_dust",
            () -> new RadioactiveItem(new Item.Properties().tab(ModItemGroups.MATERIALS), 0.001F));

    public static final RegistryObject<Item> URANIUM_INGOT = ITEMS.register("uranium_ingot",
            () -> new RadioactiveItem(new Item.Properties().tab(ModItemGroups.MATERIALS), 0.10F));

    // ============================================================
    // ====== ОРУЖИЕ И ИНСТРУМЕНТЫ ======
    // ============================================================
    public static final RegistryObject<Item> DIVINE_SWORD = ITEMS.register("divine_sword",
            () -> new DivineSword());

    public static final RegistryObject<Item> FLAMING_SWORD = ITEMS.register("flaming_sword",
            () -> new FlamingSword());

    public static final RegistryObject<Item> DARK_STEEL_SPEAR = ITEMS.register("dark_steel_spear",
            () -> new DarkSteelSpear());

    public static final RegistryObject<Item> FLAMING_PICKAXE = ITEMS.register("flaming_pickaxe",
            () -> new FlamingPickaxe());
    ...
    public static final RegistryObject<Item> HERBAL_SOLUTION = ITEMS.register("herbal_solution",
            () -> new HerbalSolution());

    public static final RegistryObject<Item> CLOTH = ITEMS.register("cloth",
            () -> new Item(new Item.Properties().tab(ModItemGroups.CONSUMABLES)));

    public static final RegistryObject<Item> DISINFECTED_CLOTH = ITEMS.register("disinfected_cloth",
            () -> new Item(new Item.Properties().tab(ModItemGroups.CONSUMABLES)));

    public static final RegistryObject<Item> HEART_ITEM = ITEMS.register("heart_item",
            () -> new HeartItem());

    public static final RegistryObject<Item> MUG_BEER = ITEMS.register("mug_beer",
            () -> new MugBeer());

    public static final RegistryObject<Item> GLASS_MUG_EMPTY = ITEMS.register("glass_mug_empty",
            () -> new Item(new Item.Properties().tab(ModItemGroups.CONSUMABLES)));
    ...
    public static final RegistryObject<Item> FERROX_ACID_TUBE = ITEMS.register("ferrox_acid_tube",
            () -> new Item(new Item.Properties().tab(ModItemGroups.CONSUMABLES).stacksTo(1)));

    public static final RegistryObject<Item> ANTIRAD = ITEMS.register("antirad",
            () -> new AntiRadItem(new Item.Properties().stacksTo(16).tab(ModItemGroups.CONSUMABLES)));

    public static final RegistryObject<Item> GEIGER_COUNTER = ITEMS.register("geiger_counter",
            () -> new GeigerCounterItem(new Item.Properties().stacksTo(1).tab(ModItemGroups.CONSUMABLES)));

    public static final RegistryObject<Item> BOTTLE_SOLUTION = ITEMS.register("bottle_solution",
            () -> new Item(new Item.Properties().tab(ModItemGroups.CONSUMABLES).stacksTo(1)));

    public static final RegistryObject<Item> EMPTY_BOTTLE_SOLUTION = ITEMS.register("empty_bottle_solution",
            () -> new Item(new Item.Properties().tab(ModItemGroups.CONSUMABLES).stacksTo(64)));

    // ============================================================
    // ====== БАТАРЕЙКИ ======
    // ============================================================
    public static final RegistryObject<Item> REDSTONE_BATTERY = ITEMS.register("redstone_battery",
            () -> new RedstoneBatteryItem());

    public static final RegistryObject<Item> LARGE_BATTERY = ITEMS.register("large_battery",
            () -> new LargeBatteryItem());

    public static final RegistryObject<Item> SUPER_BATTERY = ITEMS.register("super_battery",
            () -> new SuperBatteryItem());

    public static final RegistryObject<Item> IRON_NICKEL_BATTERY = ITEMS.register("iron_nickel_battery",
            () -> new IronNickelBattery());

    public static final RegistryObject<Item> GREEN_BATTERY = ITEMS.register("green_battery",
            () -> new GreenBattery());
    ...
    public static final RegistryObject<Item> ANCIENT_RESIN = ITEMS.register("ancient_resin",
            () -> new AncientResin());

    public static final RegistryObject<Item> LEAFY_STEM = ITEMS.register("leafy_stem",
            () -> new Item(new Item.Properties().tab(ItemGroup.TAB_MISC)));

    public static final RegistryObject<Item> NOT_RADIATION = ITEMS.register("not_radiation",
            () -> new Item(new Item.Properties().stacksTo(1)));

    public static final RegistryObject<Item> FERROX_ACID_BUCKET = ITEMS.register("ferrox_acid_bucket",
            () -> new BucketItem(ModFluids.FERROX_ACID,
                    new Item.Properties().tab(ItemGroup.TAB_MISC).stacksTo(1).craftRemainder(Items.BUCKET)));

    public static final RegistryObject<Item> LEAD_CONTAINER = ITEMS.register("lead_container",
            () -> new LeadContainerItem());
}
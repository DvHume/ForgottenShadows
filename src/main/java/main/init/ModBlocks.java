...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> BATTERY_BOX = BLOCKS.register("battery_box", () -> new BatteryBox(AbstractBlock.Properties.of(Material.METAL).strength(3.5f).requiresCorrectToolForDrops()));
